  ...
  fields: FormlyFieldConfig[] = [
    {
      ...
      templateOptions: {
        ...
        attributes: {
          class:
            'w-full px-5 py-4 text-lg rounded-xl border border-gray-300 focus:ring-2 focus:ring-[#101E8A] focus:border-[#101E8A] bg-white text-[#1d1d1f] placeholder-gray-400',
        },
    ...
    },
    {
      ...
      templateOptions: {
        ...
        attributes: {
          class:
            'w-full px-5 py-4 text-lg rounded-xl border border-gray-300 focus:ring-2 focus:ring-[#101E8A] focus:border-[#101E8A] bg-white text-[#1d1d1f]',
        },
        labelClass: 'block mb-2 text-lg font-semibold text-[#1d1d1f] drop-shadow',
      },
    },
    ...
    },
    {
      ...
      hooks: {
        onInit: (field) => {
          ...
          form
            ?.get('country')
            ?.valueChanges.pipe(switchMap((c) => (c ? this.lookup.getStates(c) : of([]))))
            .subscribe((data) => {
              field.templateOptions!.options = data;
            });
        },
